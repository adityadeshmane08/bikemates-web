...
export const STATS = [
  { label: "Verified Students", value: 48200, suffix: "+" },
  { label: "Bikes Listed", value: 9600, suffix: "+" },
  { label: "Colleges Connected", value: 320, suffix: "+" },
  { label: "Successful Trips", value: 1250000, suffix: "+", format: "compact" },
  { label: "Money Saved", value: 42, suffix: "Cr+", prefix: "₹" },
];

export const COLLEGES = [
  "IIT Bombay", "BITS Pilani", "Delhi University", "VIT Vellore", "NIT Trichy",
  "Manipal University", "SRM Chennai", "Amity Noida", "Christ Bengaluru", "Symbiosis Pune",
...
export const MODULES = [
  {
    ...
    description: "List your bike, set your own pricing, and earn from verified students on campus — fully insured and GPS-tracked.",
    accent: "#FF4B00",
  ...
  },
  {
    ...
    description: "Post your regular route and let classmates ride along. Cut your fuel bill in half while helping the campus move greener.",
    accent: "#22C55E",
  ...
  },
  {
    ...
    tag: "Ride",
    title: "Rent Bike",
    tagline: "Rent a bike from a student nearby in seconds.",
    description: "Find verified bikes around your campus, book instantly, unlock with a QR + OTP handover, and ride worry-free.",
    accent: "#3B82F6",
  ...
  },
  {
    ...
    description: "Match with student riders on your route, book a seat, split fuel transparently, and track your ride live end-to-end.",
    accent: "#A855F7",
...
export const WHY = [
  { icon: "ShieldCheck", title: "Students Only", text: "Every member is verified with a college email and ID. No strangers, ever." },
  { icon: "Wallet", title: "Genuinely Affordable", text: "Peer pricing means rides and rentals cost a fraction of commercial options." },
  { icon: "MapPin", title: "Right On Campus", text: "Bikes and rides are always minutes away, matched to your college and route." },
...
export const HOW_IT_WORKS = [
  { step: "01", title: "Verify Your Identity", text: "Sign up with your college email, driving licence and KYC. Get verified in minutes." },
...
export const SAFETY = [
  { icon: "BadgeCheck", title: "Verified Students", text: "College email + government ID verification for every user." },
...
export const BUSINESS_MODEL = [
  ...
  { title: "Campus Advertising", text: "Hyper-local brand campaigns targeted to verified students." },
  { title: "Referral Program", text: "Growth-driven rewards that expand the trusted network." },
];

export const FUTURE = [
  "Inter-college Ride Sharing", "Inter-city Student Travel", "Electric Bike Rentals",
...
export const FAQS = [
  { q: "Who can join Bikemates?", a: "Only verified college students. You must sign up with a valid college email and complete ID and KYC verification to book or list." },
  { q: "How do you verify students?", a: "We verify your college email, government ID, and driving licence (for riders). Verification usually takes just a few minutes." },
